...
def parse_summary_sections(raw_text):
    ...
    summary_pattern = re.compile(
        r'(?:Summary|सारांश|সারাংশ|சுருக்கம்|సారాంశం|સારાંશ|ಸಾರಾಂಶ|സംഗ്രഹം|ਸਾਰ|خلاصہ)\s*\n(.*?)(?=(?:Key Takeaways|मुख्य बिंदु|मुख्य मुद्दे|মূল বিষয়|முக்கிய குறிப்புகள்|ముఖ్య అంశాలు|મુખ્ય મુદ્દાઓ|ಪ್ರಮುಖ ಅಂಶಗಳು|പ്രധാന കാര്യങ്ങൾ|ਮੁੱਖ ਨੁਕਤੇ|اہم نکات|$))',
        re.DOTALL | re.IGNORECASE
    )
    takeaways_pattern = re.compile(
        r'(?:Key Takeaways|मुख्य बिंदु|मुख्य मुद्दे|মূল বিষয়|முக்கிய குறிப்புகள்|ముఖ్య అంశాలు|મુખ્ય મુદ્દાઓ|ಪ್ರಮುಖ ಅಂಶಗಳು|പ്രധാന കാര്യങ്ങൾ|ਮੁੱਖ ਨੁਕਤੇ|اہم نکات)\s*\n(.*)',
        re.DOTALL | re.IGNORECASE
    )
